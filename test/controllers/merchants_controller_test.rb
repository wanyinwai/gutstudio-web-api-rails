...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post merchants_url, params: { merchant: { company_name: @merchant.company_name, name: @merchant.name } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { company_name: @merchant.company_name, name: @merchant.name } }
